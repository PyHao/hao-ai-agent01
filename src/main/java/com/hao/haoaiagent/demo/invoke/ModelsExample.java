 ...
 */
@Component
public class ModelsExample implements CommandLineRunner {

	private final DashScopeProperties dpConfig;

	// 构造函数注入
	public ModelsExample(DashScopeProperties dpConfig) {
		this.dpConfig = dpConfig;
	}

	@Override
	public void run(String... args) throws Exception {
		System.out.println("=== Models Tutorial Examples ：simpleCall===");

//		simpleCall();
//        System.out.println("=== Models Tutorial Examples ：usePrompt ===");
//        usePrompt();
//        System.out.println("=== Models Tutorial Examples ：useChatOptions ===");
//        useChatOptions();
	...
	public void simpleCall() {
		...
		// 使用字符串直接调用
		String response = chatModel.call("介绍一下AI基建中的PCB");
	...
	public void usePrompt() {
		...
		// 创建 Prompt
		Prompt prompt = new Prompt(new UserMessage("解释AI基建中的上下游产业链"));
	...
	public void useChatOptions() {
        ...
        Prompt prompt = new Prompt(new UserMessage("你推荐的AI基建产业链中的A股上市公司及理由"));
	 ...
	 * 示例5：运行时覆盖选项
	 */
	public void runtimeOptionsOverride() {
		DashScopeApi dashScopeApi = DashScopeApi.builder()
				.apiKey(dpConfig.getApiKey())
				.build();
	 ...
	 * 示例9：与 ReactAgent 集成
	 */
	public  void integrationWithReactAgent() throws GraphRunnerException {
		DashScopeApi dashScopeApi = DashScopeApi.builder()
				.apiKey(dpConfig.getApiKey())
				.build();
	 ...
	 * 示例10：完整的配置示例
	 */
	public  void comprehensiveConfiguration() {
		DashScopeApi dashScopeApi = DashScopeApi.builder()
				.apiKey(dpConfig.getApiKey())
				.build();
	 ...
	 * 示例11：不同模型的使用
	 */
	public  void differentModelsUsage() {
		DashScopeApi dashScopeApi = DashScopeApi.builder()
				.apiKey(dpConfig.getApiKey())
				.build();
